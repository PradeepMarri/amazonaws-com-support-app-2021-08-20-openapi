# AWS Support App MCP Server

This MCP (Model Content Protocol) server provides access to AWS Support App API functionality through HTTP, HTTPS, and STDIO transport modes.
